...
namespace app\common\service\pay\driver\alipay;
...
class AlipaySubmit {
	...
	function buildRequestMysign($para_sort) {
		...
		switch (strtoupper(trim($this->alipay_config['sign_type']))) {
			case "MD5" :
				$mysign = md5Sign($prestr, $this->alipay_config['alipay_key']);
				break;
			default :
				$mysign = "";
		}
	...
	function buildRequestForm($para_temp,$jump_url='') {
		...
		header("Content-type: text/html; charset=".$this->alipay_config['input_charset']);
		//$sHtml = "<div><a href=''>支付成功</a><br/><a href=''>支付失败</a></div>";
		//$sHtml = '';
		
		$sHtml = "<html><head><title>支付安全跳转中...</title><meta http-equiv='content-type' content=".'text/html; charset=utf-8'."></head><body onload='document.alipaysubmit.submit();'>"
                        . "<meta http-equiv='content-type' content='text/html; charset=".$this->alipay_config['input_charset']."'>";
		...
		$sHtml = $sHtml."<input type='submit' value='".$button_name."'></form><div style='text-align: center;margin: 50px;'><h1>支付安全跳转中...</h1></div></body></html>";
		return $sHtml;
	}
